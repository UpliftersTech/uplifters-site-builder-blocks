 ...
 * instance. ARTWORK and ANIMATION_CSS are generated from icon.svg and must
 * be regenerated together with the other brand-icon copies whenever it
 * changes.
 *
 * Exposes:
...
(function (window, document) {
	...
	/**
	 * Create the topbar icon as a native SVG element.
	 *
	 * @param {Object}  [options]          Icon options.
	 * @param {number}  [options.size]     Rendered width and height in px.
	 * @param {boolean} [options.animated] Play the arrow draw-in and shine
	 *                                     loop. Honours prefers-reduced-motion.
	 * @return {SVGElement} Icon element.
	 */
	function createIcon(options) {
		var settings = options || {};
		var size = String(settings.size || 28);
		var animated = settings.animated !== false;

		instanceCount += 1;

		var idPrefix = 'uplifters-site-builder-blocks-editor-topbar-icon-' + instanceCount + '-';
		var className = 'uplifters-site-builder-blocks-editor-topbar-logo__icon ' + BASE_CLASS;
