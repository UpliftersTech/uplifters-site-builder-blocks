...
export const FOOTER_SECTION_NAME = 'uplifters-site-builder-blocks/footer-section';

export const footerSectionMetadata = {
	apiVersion: 3,
	name: FOOTER_SECTION_NAME,
	title: 'Footer Section',
	category: 'uplifters-site-builder-blocks-wrapper',
	parent: [ 'uplifters-site-builder-blocks/footer-layout' ],
	description: 'A section container inside the Footer Layout block for arranging responsive footer columns. All settings live on the parent Footer Layout block.',
	...
	attributes: {
		...
		verticalAlignment: {
			type: 'object',
			default: { desktop: 'center', tablet: 'center', mobile: 'center' },
		},
...
export function FooterSectionEdit( { attributes, setAttributes, clientId } ) {
	const {
		columnWidths = {},
		verticalAlignment = {},
		height = {},
...
export function FooterSectionSave() {
