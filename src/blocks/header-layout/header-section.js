...
export const HEADER_SECTION_NAME = 'uplifters-site-builder-blocks/header-section';

export const headerSectionMetadata = {
	apiVersion: 3,
	name: HEADER_SECTION_NAME,
	title: 'Header Section',
	category: 'uplifters-site-builder-blocks-wrapper',
	parent: [ 'uplifters-site-builder-blocks/header-layout' ],
	description: 'A section container inside the Header Layout block for arranging responsive header columns. All settings live on the parent Header Layout block.',
...
export function HeaderSectionEdit( {
	attributes,
	setAttributes,
	clientId,
} ) {
...
export function HeaderSectionSave() {
